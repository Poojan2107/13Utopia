# Constraints — never touch without an explicit unlock

- Canada office UI, Canada nav, fake second HQ
- Greek gods / mythology / statue identity
- ThemeForest / 1:1 clones of Munich, KOTA, etc.
- WebGL / particle carnival
- Purple-as-default AI theme
...
## Always
HTML-first copy · fast · SEO/AEO · reduced-motion safe · single `npm run dev` · feel like 13UTOPiA
